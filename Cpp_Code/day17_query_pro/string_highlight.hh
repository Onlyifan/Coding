...
void extractStrs(std::vector<std::string> &vec, const std::string &firstArg, Args &&...remainArgs);
...
// template <typename... Args>
// void render::extractStrs(std::vector<std::string> &vec, const std::string &firstArg,
//                          Args &&...remainArgs) {
...
//
// template <typename... Args>
// std::string render::highlightSubStr(const std::string &originalStr, Args &&...targetSubStrs) {
//
//     uint32_t subStrsSize = sizeof...(targetSubStrs);
//     std::vector<std::string> subStrs;
//     subStrs.reserve(subStrsSize);
...
//
//     for (uint32_t i = 0; i != subStrsSize; ++i) {
...
//                 nextPos += strlen(Color[i % Color.size( )]) + loweredSubStr.size( );
